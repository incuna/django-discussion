...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.description'
        db.add_column('discussion_discussion', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Discussion.description'
        db.delete_column('discussion_discussion', 'description')
