...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discussion.sort_order'
        db.add_column('discussion_discussion', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Discussion.sort_order'
        db.delete_column('discussion_discussion', 'sort_order')
